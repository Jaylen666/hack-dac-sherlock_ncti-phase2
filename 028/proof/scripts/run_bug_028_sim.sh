#!/usr/bin/env bash
# BUG-028 directed simulation: unit-level kv_write_rule_check.
#
...
TB_FILE="${TB_FILE:-$TB/kv_write_rule_check_bug_028_tb.sv}"
TB_TOP="${TB_TOP:-kv_write_rule_check_bug_028_tb}"
